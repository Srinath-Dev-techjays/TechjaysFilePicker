package com.techjays.filepicker.viewmodels
...
import com.techjays.filepicker.utils.registerObserver
        ...
        launchDataLoad {
            ...
            when (mediaType) {
                FilePickerConst.MEDIA_TYPE_VIDEO -> {
                    photoDirectory.name = getApplication<Application>().applicationContext.getString(
                        R.string.all_videos)
                }
